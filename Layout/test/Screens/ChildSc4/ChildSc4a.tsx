        ...
        return (
            <TouchableOpacity onPress={() => setSelectedItemIndex(index)}>
                <View style={styles.item}>
                    ...
                    <Text style={{ color: '#575E69' }}>Bộ phận đặt: <Text style={{ fontWeight: 'bold' }}>{item.bophandat}</Text></Text>
                    <View style={item.status === 1 ? styles.newStatus : styles.pendingStatus}>
                        <Text style={item.status === 1 ? styles.newStatusText : styles.pendingStatusText}>
                            {item.status === 1 ? 'Mới tạo' : 'Chờ duyệt'}
                        </Text>
                    </View>
                    {isSelected && (
                        <>
                    ...
                    {isStatusOne && (
                        <View style={styles.viewbutton}>
                            ...
                            <TouchableOpacity style={styles.itembuttonproduct}><Text style={styles.txtbuttonproduct}>Sửa</Text></TouchableOpacity>
                            <TouchableOpacity style={styles.itembuttonproducts}><Text style={styles.txtbuttonproducts}>Gửi</Text></TouchableOpacity>
                            <TouchableOpacity style={styles.itembuttonproduct}><Text style={styles.txtbuttonproduct}>Hủy</Text></TouchableOpacity>
                        </View>
                    )}
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View style={styles.view1in1}>
                    ...
                    <Text style={styles.txtview1in1}><Text style={{ fontWeight: 'bold' }}>2</Text> yêu cầu</Text>
                </View>
                <View style={styles.view1in2}>
                    <TouchableOpacity style={styles.buttonview1in2}>
                        <Feather name="send" size={15} color="white" />
                        <Text style={styles.txtview1in2}>Gửi</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.buttonview1in3}>
                        <Feather name="trash" size={15} color="#704232" />
                        <Text style={styles.txtview1in3} >Hủy</Text>
                    </TouchableOpacity>
                </View>
            </View>
            {/* <FlatList
