...
import { ChildSc16a, ChildSc16b } from '../xuathang'; // Import CustomModal component
...
export function Screen16() {
    ...
    const [selectedButton, setSelectedButton] = useState("Tổng hợp"); // State để lưu trạng thái của các nút
        ...
        <View style={styles.container}>
            ...
            <View style={styles.view2}>
                <View style={styles.view3}>
                    <TouchableOpacity
                        style={[styles.buttonview3, selectedButton === "Tổng hợp" && styles.selectedButton]} // Kiểm tra trạng thái để thay đổi màu nền
                        onPress={() => handleButtonPress("Tổng hợp")} // Xử lý sự kiện khi người dùng chọn nút
                    >
                        <Text style={[styles.textbuttonview3, selectedButton === "Tổng hợp" && styles.selectedButtonText]}>Tổng hợp</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={[styles.buttonview3, selectedButton === "Danh sách yêu cầu (2)" && styles.selectedButton]} // Kiểm tra trạng thái để thay đổi màu nền
                        onPress={() => handleButtonPress("Danh sách yêu cầu (2)")} // Xử lý sự kiện khi người dùng chọn nút
                    >
                        <Text style={[styles.textbuttonview3, selectedButton === "Danh sách yêu cầu (2)" && styles.selectedButtonText]}>Danh sách yêu cầu (2)</Text>
                    </TouchableOpacity>
                </View>
            </View>
            {selectedButton === "Danh sách yêu cầu (2)" && (
                <ChildSc16a />
            )}
            {selectedButton === "Tổng hợp" && (
                <ChildSc16b />
            )}

            {/* {selectedButton === "Tạo Mới" && (
                <View style={styles.scrollView}>
                    <View>
                        <ScrollView>
                            {dataUser.map((item) => renderItem(item, item.id))}
                        </ScrollView>
                    </View>
                    ...
                    <TouchableOpacity style={styles.btnback}>
                        <Text style={styles.txtbtnback}>Quay Lại</Text>
                    </TouchableOpacity>
                </View>
            )} */}
        </View>
