...
import { ChildSc4a, ChildSc4c } from './ChildSc4'; // Import CustomModal component
...
export function Screen4() {
    ...
    const [selectedButton, setSelectedButton] = useState("Chờ duyệt (2)"); // State để lưu trạng thái của các nút
