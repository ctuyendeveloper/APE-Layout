    ...
    const handleItemPress = (item: { id: any; name?: any; image?: any; }) => {
        ...
        switch (item.id) {
            ...
            case 2:
                ...
                navigation.navigate('scxuathang');
                break;
            case 3:
                console.log('Xin hàng'); // Điều hướng đến màn hình 'Xuất hàng'
                navigation.navigate('scxinhang');
                break;
            case 4:
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View style={styles.viewheader1}>
                    <Image style={{ width: 48, height: 48, borderRadius: 24 }} source={require('../assets/avatar.png')} />
